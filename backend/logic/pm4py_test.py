...
from logic.ocel_convert import convert_objects, filter_events_by_id, filter_events_by_type
import sys
import os
...
def run_dfg_analysis(
    ...
    try:
        ...
        print("1) Generating OCEL2", module_events)
        generate_ocel(module_events)
        print("OCEL2 generated successfully.")
