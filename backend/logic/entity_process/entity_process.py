...
class EntityProcess:
    ...
    def create_events_type(self, events: list = None):
        ...
        event_types = [
            ...
            {"name": "view_discussion", "attributes": log_attributes},
            ...
            {"name": "add_question_to_quiz", "attributes": log_attributes},
            {"name": "delete_question_from_quiz", "attributes": log_attributes},
